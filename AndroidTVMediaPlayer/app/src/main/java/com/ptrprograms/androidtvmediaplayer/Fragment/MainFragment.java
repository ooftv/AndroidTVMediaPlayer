...
public class MainFragment extends BrowseFragment {
    ...
    private void loadData() {
        String json = Utils.loadJSONFromResource( getActivity(), R.raw.shows );
        Gson gson = new Gson();
    ...
    private void setupPreferences() {
        /*
        HeaderItem gridHeader = new HeaderItem(numOfRows, "PREFERENCES", null);
    ...
    private void setBackground() {
        ...
        backgroundManager.setDrawable( getResources().getDrawable( R.drawable.ic_launcher ) );
    }
