...
public class CardPresenter extends Presenter {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        cardView.setBackgroundColor( parent.getContext().getResources().getColor( R.color.fastlane_background ) );
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
        ...
        if (movie.getCardImageUrl() != null) {
            ...
            ( (ViewHolder) viewHolder ).updateCardViewImage( ( (ViewHolder) viewHolder ).getCardView().getContext(), movie.getBackgroundImageUrl() );
        }
    }
