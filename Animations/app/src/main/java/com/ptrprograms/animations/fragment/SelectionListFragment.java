...
import com.ptrprograms.animations.activity.RipplesActivity;
import com.ptrprograms.animations.activity.SceneAnimationActivity;
...
public class SelectionListFragment extends ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if( text.equalsIgnoreCase( CATEGORY_EXPLOSION_REVEAL ) ) {
            ...
            intent = new Intent( getActivity(), RipplesActivity.class );
        }
        ...
        } else if( text.equalsIgnoreCase( CATEGORY_SCENE_TRANSITION ) ) {
            intent = new Intent( getActivity(), SceneAnimationActivity.class );
        }
